...
async function runPipeline(job) {
    ...
    try {
        ...
        console.log(`   🔍 Using search vibe: "${searchVibe}"`);
...
if (require.main === module) {
    ...
    if (fs.existsSync(briefPath)) {
        console.log('📄 Found existing product-brief.md, using real data...');
        ...
        console.log(`   🎨 Vibe: ${clientVibe}`);
    } else {
        console.log('⚠️ No product-brief.md found, using fallback test data...');
